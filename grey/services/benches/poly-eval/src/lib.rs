...
//! Horner's method. Memory access is sequential streaming read of `coeffs[]`
//! (4096 × u64 = 32 KiB, fits in L1). Compute: `DEGREE-1` chained `mul + add`
//! per point — totally dependent (each step needs the previous result).
//!
//! Complements:
