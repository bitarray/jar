...
//! the recursive-spawn-with-data bench guest. Mirrors
//! `bench-sub-vm-recurse::kernel_abi`; trimmed to the two ops used
//! by `derive_spawn` + `host_call`.
...
/// → child's φ[7..=8] and zeros higher arg slots.
#[inline]
